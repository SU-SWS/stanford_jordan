 ...
 */
function stanford_c1_default_theme_settings() {
  $defaults = array(
 ...
 */
function stanford_c1_initialize_theme_settings($theme_name) {
  ...
  if (!isset($theme_settings['primary_menu_dropdown']) || $theme_settings['rebuild_registry'] == 1) {
    ...
    $defaults = array_merge(stanford_c1_default_theme_settings(), $info_theme_settings);
...
function phptemplate_settings($saved_settings) {
  ...
  $form['tnt_container'] = array(
    '#type' => 'fieldset',
    '#title' => t('Stanford_c1 theme settings'),
    '#description' => t('Use these settings to enhance the appearance and functionality of your Stanford_c1 theme.'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
