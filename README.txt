...
The Stanford Jordan Drupal theme is intended for Drupal versions 6 only; it will not work with Drupal 5 or below.  You must install the Stanford Framework base theme for Stanford Jordan to operate properly.
